...
export class Extractor implements IExtractor {
    ...
    async process(text: string): Promise<GraphData> {
        ...
        console.log(`[${this.name}] Using fallback llm.chat with manual JSON parsing...`);
        ...
        console.log(`[${this.name}] Raw LLM output (first 500 chars):`, typeof rawOutput === 'string' ? rawOutput.substring(0, 500) : rawOutput);
        let jsonData: any;
